...
DEFAULT_FROM_EMAIL = 'AlifPro Academy <support@alifpro.uz>'

# CORS Settings for development
CORS_ALLOWED_ORIGINS = [
    "http://localhost:8000",
    "http://127.0.0.1:8000",
    "http://127.0.0.1:52890",
]
...
# Password Hashers (using Django defaults)
PASSWORD_HASHERS = [
...
# Allauth settings (new format for django-allauth >= 0.60)
...
JAZZMIN_SETTINGS = {
    ...
    "search_model": ["auth.User", "arab.VocabularyCategory"],
    "user_menu_links": [
