"""
Custom jazzmin templatetags override to fix Django 6.0 compatibility.
Django 6.0 removed support for format_html() without args/kwargs.
"""
...
def jazzmin_paginator_number(change_list: ChangeList, i: int) -> SafeText:
    ...
    Fixed for Django 6.0 compatibility - uses mark_safe instead of format_html without args.
    """
    html_str = ""
    start = i == 1
    ...
    # Use mark_safe instead of format_html() without args - Django 6.0 fix
